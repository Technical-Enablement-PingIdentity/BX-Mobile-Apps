...
NSString *const kCustomerUrl            = @"http://bxfinance.xyz/pingidsdk";  //For example: @"http://www.example.com/pingidsdk"
NSString *const kAppID                  = @"ff8bbe92-d676-4d3c-9580-1afb441d339a";                      //For example: @"c0a658e0-47dc-4cb4-80d7-1a59a6a8a621";

#pragma mark - Ping Federate

NSString *const kIssuer                 = @"https://demo.bxfinance.xyz";
NSString *const kClientID               = @"bxFinanceMobile";
NSString *const kRedirectURI            = @"bxfinancemobile://cb";
...
NSString *const kModernoCopyRight       = @"© %@ BXFinance\nv%@";
