...
public class CameraSource {
    ...
    private Camera createCamera() {
        ...
        Log.e("HERE", "Size = " + mPreviewSize.toString() + " picutre = " + pictureSize.toString());
    ...
    public void stop(){
        ...
        synchronized (mCameraLock){
            System.out.println("STOPPING CAMERA1");

            mFrameProcessor.setActive(false);
            if (mProcessingThread != null) {
                System.out.println("STOPPING CAMERA2");

                try {
                    // Wait for the thread to complete to ensure that we can't have multiple threads
                    // executing at the same time (i.e., which would happen if we called start too
                    // quickly after stop).
                    mProcessingThread.join(100);
                } catch (InterruptedException e) {
                    Log.d(TAG, "Frame processing thread interrupted on release.");
                }
                mProcessingThread = null;
            }
            System.out.println("STOPPING CAMERA3");

            // clear the buffer to prevent oom exceptions
            mBytesToByteBuffer.clear();
            if(mCamera!=null){
                System.out.println("STOPPING CAMERA4");
    ...
    /**
     * Gets the id for the camera facing back.  Returns -1 if no such
     * camera was found.
     */
