...
class VerifyHomeViewController: UIViewController {
    ...
    func initApp() {
        ...
        self.navigationItem.setRightBarButton(self.qrScannerButton, animated: false)
        self.navigationItem.setLeftBarButton(self.settingsButton, animated: false)
    ...
    @IBAction func segueUnwindAction(unwindSegue: UIStoryboardSegue) {
    }
